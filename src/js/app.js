...
function iniciarApp() {
    ...
    tabs(); //Cambia la seccion cuando se envien los tabs
...
function seleccionarServicio(servicio) {
    ...
    //identificar el elmenteo al que se le da click
...
async function reservarCita() {
    ...
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'hHubo un error al guardar la cita'
          })
    }

    

    // console.log([...datos]);//para comprobar el contenido
}